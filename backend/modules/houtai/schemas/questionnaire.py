...
class QuestionCreate(BaseModel):
    ...
    depends_on: Optional[str] = None  # JSON: {"question_id": "...", "value": "..."}
    options: Optional[Any] = None
    placeholder: Optional[str] = None
    hint: Optional[str] = None
    order_index: Optional[Any] = 0
    ...
    @classmethod
    def normalize_order_index(cls, v):
        if v is None or v == "":
            return 0
        try:
            return int(v)
...
class QuestionUpdate(BaseModel):
    ...
    conditional_required: Optional[bool] = None
...
class QuestionUpsert(BaseModel):
    ...
    @classmethod
    def normalize_order_index(cls, v):
        return QuestionCreate.normalize_order_index(v)
...
class QuestionnaireUpdate(BaseModel):
    ...
    customer_type: Optional[str] = None
    questions: Optional[List[QuestionUpsert]] = None
...
class QuestionnaireSubmissionListItem(BaseModel):
    id: str
...
class QuestionnaireSubmissionDetail(QuestionnaireSubmissionListItem):
